...
const dictEn: Record<string, string> = {
  ...
  "INV_PROD_4_NAME": "Laboratory Incubator Oven",
  "INV_PROD_4_DESC": "High-uniformity thermal chamber with dual PT1000 RTD sensors, overtemperature cut-off, and PID heating control.",
  "INV_PROD_5_NAME": "Refrigerated Cooler Incubator",
  "INV_PROD_5_DESC": "Low-vibration biological refrigerated incubation unit with cascade cooling control and sub-zero precision.",
  "INV_PROD_6_NAME": "Laboratory Autoclave",
  "INV_PROD_6_DESC": "Safety-critical high-pressure steam sterilization controller with multi-stage interlocks and pressure validation.",
...
const dictFa: Record<string, string> = {
  ...
  "INV_PROD_4_NAME": "آون و انکوباتور آزمایشگاهی",
  "INV_PROD_4_DESC": "محفظه حرارتی با یکنواختی دمای بالا، حسگرهای دوگانه PT1000، قطع‌کننده اضافه دما و کنترل حرارتی دقیق PID.",
  "INV_PROD_5_NAME": "انکوباتور یخچال‌دار و کولر",
  "INV_PROD_5_DESC": "واحد انکوباتور بیولوژیکی یخچال‌دار بدون لرزش با سیستم کنترل آبشاری سرما و دقت دمایی بالا.",
  "INV_PROD_6_NAME": "اتوکلاو استریلیزاسیون آزمایشگاهی",
  "INV_PROD_6_DESC": "کنترلر استریلیزاسیون بخار پرفشار ایمن با قفل‌های حفاظتی چندمرحله‌ای و اعتبارسنجی مداوم فشار و دما.",
