export const translations = {
  ...
  fa: {
    ...
    "TECH_L2_TITLE": "لایه ۲: پردازش داده و هوش لبه‌ای (Edge AI)",
    "TECH_L2_DESC": "کنترل کیفیت و بازرسی بصری آنی با YOLOv8 و اجرای مدل‌های زبانی محلی (SLM) برای تحلیل لاگ‌های خطا و نگهداری پیشگیرانه.",

    "TECH_L3_TITLE": "لایه ۳: اتصال و اینترنت اشیاء صنعتی (IIoT)",
    "TECH_L3_DESC": "پروتکل MQTT بدون تخصیص حافظه پویا (Heap-Free)، بافرهای DMA بدون کپی (Zero-Copy) و سرویس‌های سریع ابری با Actix و دیتابیس SurrealDB.",

    "TECH_L4_TITLE": "لایه ۴: رابط کاربری صنعتی (HMI)",
    "TECH_L4_DESC": "رابط گرافیکی مدرن Slint با اجرای مستقل از کتابخانه استاندارد روی نمایشگرهای لمسی، پنل‌های تعبیه‌شده و سیستم‌های عامل صنعتی.",
